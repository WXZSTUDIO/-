...
export const Icons = {
  ...
  Memory: (props: IconProps) => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="M20.66 7S22 10 22 12c0 2-1.34 5-1.34 5"></path>
      <path d="M3.34 7S2 10 2 12c0 2 1.34 5 1.34 5"></path>
      <path d="M12 12a3 3 0 1 0 0-6 3 3 0 0 0 6Z"></path>
    </svg>
  ),
